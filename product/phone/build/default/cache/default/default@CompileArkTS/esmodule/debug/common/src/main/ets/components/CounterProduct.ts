...
export class CounterProduct extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.width({ "id": 134217915, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Row.height({ "id": 134217933, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.disabled ? { "id": 134217941, "type": 20000, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" } : { "id": 134217940, "type": 20000, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.width({ "id": 134217914, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
