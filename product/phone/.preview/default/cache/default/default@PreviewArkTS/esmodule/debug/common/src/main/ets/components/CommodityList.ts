...
export class CommodityList extends ViewPU {
    ...
    CommodityItem(info: Commodity, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("common/src/main/ets/components/CommodityList.ets(32:5)", "@ohos/common");
            Column.padding({ "id": 134217938, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Column.height({ "id": 134217918, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("common/src/main/ets/components/CommodityList.ets(33:7)", "@ohos/common");
            Image.width({ "id": 134217919, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Image.height({ "id": 134217919, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("common/src/main/ets/components/CommodityList.ets(41:7)", "@ohos/common");
            Column.width(StyleConstants.FULL_WIDTH);
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 134217894, "type": 10003, params: [info.title, info.description], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Text.debugLine("common/src/main/ets/components/CommodityList.ets(42:9)", "@ohos/common");
            ...
            Text.lineHeight({ "id": 134217917, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 134217893, "type": 10003, params: [info.price], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Text.debugLine("common/src/main/ets/components/CommodityList.ets(49:9)", "@ohos/common");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("common/src/main/ets/components/CommodityList.ets(56:9)", "@ohos/common");
            Text.fontSize({ "id": 134217925, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Text.fontColor(Color.White);
            Text.backgroundColor({ "id": 134217900, "type": 10001, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Text.borderRadius({ "id": 134217932, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            ...
            if (this.commodityList.length > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        List.debugLine("common/src/main/ets/components/CommodityList.ets(79:7)", "@ohos/common");
                        ...
                        const __lazyForEachItemGenFunction = _item => {
                            const item = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.debugLine("common/src/main/ets/components/CommodityList.ets(81:11)", "@ohos/common");
                                };
