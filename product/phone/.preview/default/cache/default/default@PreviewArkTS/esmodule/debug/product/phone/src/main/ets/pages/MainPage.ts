...
class MainPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("product/phone/src/main/ets/pages/MainPage.ets(90:5)", "phone");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("product/phone/src/main/ets/pages/MainPage.ets(91:7)", "phone");
            Tabs.barWidth(this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? { "id": 134217746, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" } : StyleConstants.FULL_WIDTH);
            Tabs.barHeight(this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ?
                StyleConstants.SIXTY_HEIGHT : { "id": 134217931, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("product/phone/src/main/ets/pages/MainPage.ets(95:9)", "phone");
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
            ...
            TabContent.debugLine("product/phone/src/main/ets/pages/MainPage.ets(102:9)", "phone");
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
            ...
            TabContent.debugLine("product/phone/src/main/ets/pages/MainPage.ets(107:9)", "phone");
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
            ...
            TabContent.debugLine("product/phone/src/main/ets/pages/MainPage.ets(115:9)", "phone");
        }, TabContent);
        TabContent.pop();
        Tabs.pop();
        Column.pop();
    ...
    BottomNavigation(button: ButtonInfoModel, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("product/phone/src/main/ets/pages/MainPage.ets(139:5)", "phone");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("product/phone/src/main/ets/pages/MainPage.ets(140:7)", "phone");
            Image.objectFit(ImageFit.Contain);
            Image.width({ "id": 134217747, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Image.height({ "id": 134217747, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(button.title);
            Text.debugLine("product/phone/src/main/ets/pages/MainPage.ets(144:7)", "phone");
            Text.fontColor(this.currentPageIndex === button.index ? { "id": 134217900, "type": 10001, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" } : Color.Black);
