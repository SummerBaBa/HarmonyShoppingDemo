...
export class OrderDetailList extends ViewPU {
    ...
    OrderTabs(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(28:5)", "orderdetail");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Tabs.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(29:7)", "orderdetail");
            ...
            Tabs.margin({
                top: { "id": 134217929, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" }, bottom: { "id": 134217929, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" }
            });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TabContent.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(33:9)", "orderdetail");
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
            ...
            TabContent.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(40:9)", "orderdetail");
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(48:11)", "orderdetail");
                    Column.width(StyleConstants.FULL_WIDTH);
                    Column.height(StyleConstants.FULL_HEIGHT);
                }, Column);
                {
            ...
            TabContent.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(47:9)", "orderdetail");
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
            ...
            TabContent.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(56:9)", "orderdetail");
        }, TabContent);
        TabContent.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            TabContent.create(() => {
            ...
            TabContent.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(63:9)", "orderdetail");
        }, TabContent);
        TabContent.pop();
        Tabs.pop();
        Column.pop();
    ...
    tabBar(text: string | Resource, index: number, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(86:5)", "orderdetail");
            Flex.width(StyleConstants.FULL_WIDTH);
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(text);
            Text.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(87:7)", "orderdetail");
            Text.fontSize({ "id": 134217926, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Text.textAlign(TextAlign.Center);
            Text.fontColor(this.currentTabIndex === index ? { "id": 134217900, "type": 10001, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" } : { "id": 134217903, "type": 10001, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" });
            Text.fontWeight(this.currentTabIndex === index ? StyleConstants.FONT_WEIGHT_FIVE : StyleConstants.FONT_WEIGHT_FOUR);
            Text.border({
                color: { "id": 134217900, "type": 10001, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" },
                width: { bottom: this.currentTabIndex === index ? { "id": 134217941, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" } : { "id": 134217786, "type": 10002, params: [], "bundleName": "com.example.multishopping", "moduleName": "phone" } }
            });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("features/orderdetail/src/main/ets/components/OrderDetailList.ets(102:5)", "orderdetail");
